...
from services.auto_exclude.JavaScriptNodeJsAutoExclude import (
    JavaScriptNodeJsAutoExclude,
)
...
class ExclusionServiceFactory:
    ...
    ) -> List[ExclusionService]:
        services = [
            IDEandGitAutoExclude(
                start_directory, project_type_detector, settings_manager
            )
        ]
